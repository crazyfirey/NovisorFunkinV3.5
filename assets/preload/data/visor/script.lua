...
function onStartCountdown()
    for i = 0, getProperty('opponentStrums.length')-1 do
        ...
        setPropertyFromGroup('opponentStrums', i, 'texture', 'notes/black');
        ...
        setPropertyFromGroup('unspawnNotes', i, 'texture', 'notes/black');
...
function onBeatHit()
    ...
    if curBeat == 96 or curBeat == 128 or curBeat == 192 or curBeat == 256 or curBeat == 384 or curBeat == 448 then

...
function onCreate()
    ...
    makeLuaSprite('bartop','',0,-600)
    makeGraphic('bartop',1280,400,'000000')
    addLuaSprite('bartop',false)
    setObjectCamera('bartop','hud')
    setScrollFactor('bartop',0,0)

    makeLuaSprite('barbot','',0, 800)
    makeGraphic('barbot',1280,400,'000000')
...
function onBeatHit()
    ...
    if curBeat == 144 then
        doTweenY('top', 'bartop', -200, 2, 'expoOut')
        doTweenY('bottom', 'barbot', 530, 2, 'expoOut')
        setProperty('defaultCamZoom', 1.2)
    end

    if curBeat == 148 then
        doTweenY('top', 'bartop', -600, 2, 'expoIn')
        doTweenY('bottom', 'barbot', 800, 2, 'expoIn')
        setProperty('defaultCamZoom', 0.95)
    end
    
    if curBeat == 203 then
        doTweenY('top', 'bartop', -300, 2, 'expoOut')
        doTweenY('bottom', 'barbot', 630, 2, 'expoOut')
    end

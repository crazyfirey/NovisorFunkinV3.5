...
class VisualsUISubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Hide Text Watermark',
		    "If checked, it's gonna hide the watermark on your song.",
			'hidepe',
			'bool',
			false);
		addOption(option);

		var option:Option = new Option('Hide Title Sidebar',
		    "If checked, We will have the title sidebar to all songs",
			'hidesidebar',
			'bool',
			true);
		addOption(option);

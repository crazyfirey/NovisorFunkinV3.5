...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Black Screen', "Value 1: None\nValue 2: None"],
		['Remove Black Screen', "Value 1: None\nValue 2: None"],
		['Light Switch', "Value 1: None\nValue 2: None"]
	];
	...
	**/
	...
	function addNoteUI():Void
	{
		...
		directories.push(Paths.getPreloadPath('notes/'));
		directories.push(Paths.getPreloadPath(Paths.currentModDirectory + '/notes/'));
		for(mod in Paths.getGlobalMods())
			directories.push(Paths.getPreloadPath(mod + '/notes/'));
